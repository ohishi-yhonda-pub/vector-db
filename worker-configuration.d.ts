/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: b53385ccfdd2cc899655a944c630ea5f)
// Runtime types generated with workerd@1.20250816.0 2024-12-18 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		ENVIRONMENT: "development";
		DEFAULT_EMBEDDING_MODEL: string;
		DEFAULT_TEXT_GENERATION_MODEL: string;
		IMAGE_ANALYSIS_PROMPT: string;
		IMAGE_ANALYSIS_MAX_TOKENS: string;
		TEXT_EXTRACTION_MAX_TOKENS: string;
